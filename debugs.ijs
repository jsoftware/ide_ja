...
jdb_empty=: empty f.
jdb_expand=: expand f.
jdb_isparent=: 0:`wdisparent@.IFJA f.
...
'HWNDP' jdb_default ''
if. 0>4!:0 <'WINPOS' do.
  WINPOS=: 0 ". (<0 1) >@{ jdb_wd 'jcstate debugpos'
end.
jdb_debugreset''
)
jdb_debugreset=: 3 : 0
...
JDEBUG=: 0 : 0 rplc 'DEBUGPATH';(jpath '~addons/ide/ja/images');'DTTCURR';DTTCURR;'DTTTOGGLE';DTTTOGGLE
