...
wd 'sm open tab ~addons/ide/ja/demo/spinbox.ijs'  NB. open file, in new tab if necessary
...
Note''
wd 'sm replace edit ~Ja/demo/spinbox.ijs'  NB. replace current edit window with filename
