...
NB. load '~addons/ide/ja/demo/glc.ijs'

coclass 'jademo'

glc_run=: 3 : 0
require'~addons/ide/ja/ja.ijs'
require'~addons/ide/ja/console.ijs'
((<'jgl2') -.~ copath 'jademo') copath 'jademo'
coinsert 'jglc'
...
((<'jglc') -.~ copath 'jademo') copath 'jademo'
