...
r=. ''
r=. r,'f96b697d7cb7938d525a2f31aaf161d0' -: gethash_ja_ 'md5';T
r=. r,'e2c865db4162bed963bfaa9ef6ac18f0' -: gethash_ja_ 'md5';a.
r=. r,'c12252ceda8be8994d5fa0290a47231c1d16aae3' -: getsha1_ja_ T
r=. r,'a9993e364706816aba3e25717850c26c9cd0d89d' -: getsha1_ja_ W
if. if53 do.
  f=. gethash_ja_ @ (;&W)
